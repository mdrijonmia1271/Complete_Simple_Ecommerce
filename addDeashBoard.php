...
if(isset($_POST['submit'])){
  ...
  if(!empty($category_name_id) && !empty($admin_name) && !empty($sub_category_name_id) && !empty($color_name_id) && !empty($size_name_id) && !empty($packet_name_id) && !empty($quantity)){
    $statement = $pdo ->prepare('INSERT INTO deash_board (category_name_id, admin_name, sub_category_name_id, color_name_id, size_name_id, packet_name_id, quantity, description, create_date, status)
                 VALUE(:category_name_id, :admin_name, :sub_category_name_id, :color_name_id, :size_name_id, :packet_name_id, :quantity, :description, :date, :status)');
